...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(1920, 1080, "", nullptr, nullptr);
    if (window == nullptr)
        return 1;
    ...
    ImFont* defaultFont = io.Fonts->AddFontFromFileTTF("../fonts/Cousine-Regular.ttf", 15.0f, nullptr, io.Fonts->GetGlyphRangesJapanese());
